    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        do{
            try {
               ...
               // filmes.ler("/mnt/c/temp/2022-1/AULAS/TP02/filmes/" + entrada);
            ...
            switch(operacao){
                ...
                try{
                   // filmes.ler("/mnt/c/temp/2022-1/AULAS/TP02/filmes/" + entradaOperacao);
                    ...
                    listafilmes.inserirInicio(filmes);
                } catch  (Exception e){
                    System.out.println("Deu bug no InserirInicio no switchc case");
                    e.printStackTrace();
                }
                break;
                case "IF":
                ...
                try{
                    listafilmes.remover(Integer.parseInt(entradaOperacao));
                } catch (Exception e){
                    System.out.println("Deu bug no remover de  qualquer posicao no switch case.");
                    e.printStackTrace();
                }
                ...
                case "RI":
                try{
                    listafilmes.removerInicio();
                } catch (Exception e){
                    System.out.println("Deu bug no removerInicio no switch case");
                    e.printStackTrace();
                }
                break;
                case "RF":
                ...
                String entradaReal = "";
                try{
                    while(entradaOperacao.charAt(pos) != ' '){
                        posEntrada+=entradaOperacao.charAt(pos);
                        pos++;
                    }
                    pos++;
                    while(pos!=entradaOperacao.length()){
                        entradaReal+=entradaOperacao.charAt(pos);
                        pos++;
                    }
                } catch (Exception e){
                ...
                try{
                   // filmes.ler("/mnt/c/temp/2022-1/AULAS/TP02/filmes/" + entradaReal);
                    filmes.ler("/tmp/filmes/"+ entradaReal);
                    listafilmes.inserir(filmes, Integer.parseInt(posEntrada));
                } catch (Exception e){
                    System.out.println("Deu bug no inserir no switch case.Pos entrada: " + posEntrada + " entradaReal: " + entradaReal );
                    e.printStackTrace();
                }
                break;
...
class Lista {
    ...
    public void listaImprimir() {
        ...
        for (int i=0;i<n;i++){
            System.out.println("[" + i + "] " +  tempArray[i].getNome() + " " + tempArray[i].getTituloOriginal() + " " + tempArray[i].getDataLancamento() + " " + String.valueOf(tempArray[i].getDuracao()) + " " + tempArray[i].getGenero()
