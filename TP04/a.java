...
class a {
    public static void main(String[] args) throws NoSuchElementException {
        ...
        try {
            entrada = "";
            entrada = sc.nextLine();
            testes = Integer.parseInt(entrada.trim());

            do {
                ArvoreBinaria arvore = new ArvoreBinaria();
                entrada = sc.nextLine();
                tamArvore = Integer.parseInt(entrada.trim());
                entrada = sc.nextLine();
                numeros = entrada.trim();
                    int n = 0;
                ...
                for (int i = 0; i < numeros.length(); i++) {
                    if (numeros.charAt(i) != ' ' && numeros.charAt(i) >= 48 && numeros.charAt(i) <= 57) {
                        arvore.inserir(Character.getNumericValue(numeros.charAt(i)));
                    }
                }
                -----------------------TESTE 2 ------------------------
                */
                System.out.println("Case " + controlador + ":");
                controlador++;
